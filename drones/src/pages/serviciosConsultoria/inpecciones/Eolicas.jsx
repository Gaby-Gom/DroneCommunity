...
<div className="bg-white w-full h-full flex flex-col items-center overflow-auto p-4 lg:p-10">
  ...
  />
      ...
      <div className="flex flex-row   justify-center items-center w-full">
        <h6 className="m-5 font-bold h-6 mt-3 text-colorFontPrimary text-xs leading-8 uppercase">Cantidad de Turbinas</h6>
        <div className="bg-white my-2 p-1 flex border border-gray-200 rounded">
          <input type="text" minLength="1" maxLength="999" className="border-none p-2 rounded-lg text-black focus:ring-2 focus:ring-sky-500 focus:outline-none bg-sky-100  font-bold  w-16 text-center" />
        </div>
