    ...
    <div className="flex flex-row   justify-center items-center w-full">
        ...
        <div className="bg-white my-2 p-1 flex border border-gray-200 rounded">
          <select
            ...
            <option className="text-black cursor-pointer  text-center" value="Interna">Interna</option>
          ...
          <select
            ...
            name=""
            className="p-1 px-2 outline-none w-full text-colorFontPrimary cursor-pointer">
            <option className="text-black cursor-pointer  text-center" value="Interna">RGB</option>
            <option  className="text-black cursor-pointer text-center" value="Externa">Térmica</option>
          </select>
        </div>
